...
Every invocation creates one final GitHub issue containing the starting
configuration, expected branch sequence, scenario results, and links to the
originating, cascade, collision, and repair PRs. Failed runs publish the partial
results collected before the failure whenever GitHub remains reachable.
